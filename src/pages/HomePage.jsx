...
const HomePage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#1a1c22]">
      <TheHeader />
      <div className="relative overflow-hidden flex flex-col justify-center items-center text-center space-y-5 lg:py-20 px-4">
        {/* logo */}
        ...
        <div className="flex flex-col space-y-3">
          <div className="space-y-4">
            ...
            <p className="text-lg md:text-xl font-medium text-slate-600 dark:text-cyan-100/70 max-w-2xl">
              Live Internship 2025 | React Daily tasks and projects.
            </p>
          </div>
          <div className="flex items-center justify-center gap-4">
            <Link
              to="https://github.com/dhinakaran-Y/CD-Learn-React"
              target="_blank"
              className="group flex items-center gap-3 bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 px-6 py-3 rounded-2xl shadow-sm hover:shadow-cyan-500/20 hover:border-cyan-500/50 transition-all duration-300">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
                viewBox="0 0 432 416"
                className="group-hover:fill-cyan-500 fill-slate-700 dark:fill-white transition-colors">
